...
// curl -F "meeting.wav=@/Users/cunnie/Google Drive/BlabberTabber/ICSI-diarizer-sample-meeting.wav" -H "diarizer: Aalto" -H "transcriber: CMU Sphinx 4" http://test.diarizer.com:8080/api/v1/upload
// curl -F "meeting.wav=@/Users/cunnie/Google Drive/BlabberTabber/ICSI-diarizer-sample-meeting.wav" -H "diarizer: Aalto" -H "transcriber: CMU Sphinx 4" https://diarizer.com:9443/api/v1/upload
